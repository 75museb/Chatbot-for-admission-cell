...
data = pd.read_csv("D:\\DYP-ATU Chabot\\dypatudata2.csv",encoding = 'ISO-8859-1')
...
trainx, testx, trainy, testy = tts(X, y, test_size=.3, random_state=6)
...
def get_response2(usr):
    ...
    if usr.lower() in a:
        return ("You can ask me questions related to: Admission Process of  D. Y. Patil Agriculture and Technical University, Talsande.")
    ...
    if max(cos_sims) == [[1.]]:
        return "I'm not able to solve this question at this moment. You can contact to help center 9764440326 \U0001F615"
    ...
    if max(cos_sims) > [[0.]]:
        ...
        c = "(2)" + data['Question'][questionset.index[15]]
        d = "(3)" + data['Question'][questionset.index[40]]
        e = "(4)" + data['Question'][questionset.index[79]]
        f = "(5)" + data['Question'][questionset.index[123]]
